...
`);
  ...
  // res/js/src/load-csv.js
  var require_load_csv = __commonJS({
    "res/js/src/load-csv.js"(exports, module) {
      var { DataFrame, median, range } = require_src();
      var fs = (() => {
        try {
          return __require("fs");
        } catch (e) {
      ...
      module.exports = async function loadCSV2(path, options) {
